    ...
    class Village
    {
        ...
        public static void Draw(SpriteBatch spriteBatch)
        {
            foreach (Village v in villages)
            {
                ...
                Vector2 o = Main.font0.MeasureString(v.guys.ToString()) * .5f;
                //outline
                spriteBatch.DrawString(Main.font0, v.guys.ToString(), v.position + new Vector2(2, -Main.villageTexture.Height), Color.Black, 0f, o, 1f, SpriteEffects.None, (Main.screenHeight - v.position.Y) / (float)Main.screenHeight);
                spriteBatch.DrawString(Main.font0, v.guys.ToString(), v.position + new Vector2(-2, -Main.villageTexture.Height), Color.Black, 0f, o, 1f, SpriteEffects.None, (Main.screenHeight - v.position.Y) / (float)Main.screenHeight);
                spriteBatch.DrawString(Main.font0, v.guys.ToString(), v.position + new Vector2(0, -Main.villageTexture.Height + 2), Color.Black, 0f, o, 1f, SpriteEffects.None, (Main.screenHeight - v.position.Y) / (float)Main.screenHeight);
                spriteBatch.DrawString(Main.font0, v.guys.ToString(), v.position + new Vector2(0, -Main.villageTexture.Height - 2), Color.Black, 0f, o, 1f, SpriteEffects.None, (Main.screenHeight - v.position.Y) / (float)Main.screenHeight);
                spriteBatch.DrawString(Main.font0, v.guys.ToString(), v.position + new Vector2(0, -Main.villageTexture.Height), Color.White, 0f, o, 1f, SpriteEffects.None, (Main.screenHeight - v.position.Y - 1f) / (float)Main.screenHeight);
            }
        }
    }
}
